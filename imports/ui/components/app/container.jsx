...
const AppContainer = (props) => {
  const { navbar, actionsbar, media, ...otherProps } = props;
  ...
  withModalMounter(
    withTracker(({ intl, baseControls }) => {
      ...
      if (!currentUser.approved) {
        baseControls.updateLoadingState(
          intl.formatMessage(intlMessages.waitingApprovalMessage)
        );
      }
